...
class Drive_Until_Over_Defense( Command ):
	...
	def execute( self ):
		...
		accelerometer_Z = robot.accel.getZ()
		if accelerometer_Z < const.NEGATIVE_ACCEL_VALUE:
			self.going_down += 1

		if self.going_down >= 2:
			self.over_defense = True
